...
import json
import sys
from meld_data import prepare_dataloaders
...
def parse_args():
    ...
    # Data directories
    parser.add_argument("--train-dir", type=str, default=os.environ.get(
    'SM_CHANNEL_TRAINING', "/opt/ml/input/data/training"))
    parser.add_argument("--val-dir", type=str, default=os.environ.get(
    'SM_CHANNEL_VALIDATION', "/opt/ml/input/data/validation"))
    parser.add_argument("--test-dir", type=str, default=os.environ.get(
